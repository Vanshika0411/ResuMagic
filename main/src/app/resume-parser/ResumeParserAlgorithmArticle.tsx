  ...
  return (
    <article className="mt-10">
      ...
      <Paragraph smallMarginTop={true}>
        For the technical curious, this section will dive into the RESUMAGIC
      ...
      <Paragraph>
        And that is everything about the RESUMAGIC parser algorithm :)
      </Paragraph>
      <Paragraph>
        Written by <Link href="">VS Solution's</Link> on
        April 2025
      </Paragraph>
    </article>
  );
