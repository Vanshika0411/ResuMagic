...
import testimonialSpiegelSrc from "public/assets/image1.jpeg";
import testimonialSantiSrc from "public/assets/image2.jpeg";
import testimonialVivianSrc from "public/assets/image3.jpeg";
...
const TESTIMONIALS = [
  {
    ...
    quote:
      "Students often make silly mistakes on their resume by using inconsistent bullet points or font sizes. RESUMAGIC’s auto format feature is a great help to ensure consistent format.",
    name: "Ms. Snow",
    title: "Educator",
  },
  {
    ...
    quote:
      "I used RESUMAGIC during my last job search and was invited to interview at top tech companies such as Google and Amazon thanks to its slick yet professional resume design.",
    name: "Mr. Brown",
  ...
  },
  {
    ...
    quote:
      "Creating a professional resume on RESUMAGIC is so smooth and easy! It saves me so much time and headache to not deal with google doc template.",
    name: "Mr. Carl",
